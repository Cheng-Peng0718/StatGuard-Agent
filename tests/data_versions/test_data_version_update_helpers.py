...
def test_extract_data_version_update_from_payload():
    update = {
    ...
    raw_result = {
        "payload": {
            "data_version_update": update,
        }
    }

    assert extract_data_version_update(raw_result) == update


def test_extract_data_version_update_from_top_level():
    update = {
        "active_data_version_id": "data_v_1",
    }
...
def test_extract_data_version_update_from_details():
    update = {
        "active_data_version_id": "data_v_1",
    }
...
def test_validate_data_version_update_requires_new_version_dict():
    result = validate_data_version_update({
        "old_version_id": "raw_v1",
...
def test_validate_data_version_update_fills_missing_new_version_id_field():
    result = validate_data_version_update({
        "old_version_id": "raw_v1",
        "new_version_id": "data_v_1",
        "active_data_version_id": "data_v_1",
